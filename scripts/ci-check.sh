...
export NEXT_PUBLIC_PIPES_API_URL="${NEXT_PUBLIC_PIPES_API_URL:-https://pipes.trace-flow.dev}"
export NEXT_PUBLIC_RAW_API_URL="${NEXT_PUBLIC_RAW_API_URL:-https://raw.trace-flow.dev}"
...
python3 scripts/ci/ubuntu_https_sources_test.py
bun test scripts/ingest-recovery/agent-*.test.ts
