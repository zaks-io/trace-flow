...
FORBIDDEN='agent-ingest-dev|agent-ingest-dlq-dev|agent-snapshot-dev|trace-flow-agent-deliveries-dev|trace-flow-agent-ingest-dev|trace-flow-agent-consumer-dev|"?2006"?|25a35f71a8d64884a8e8935056880dba|f945ee3d71954ffabd364e3db385d3ab'
