...
export default function AdminAnalytics() {
  ...
  const getDashboard = useAction(api.adminAnalytics.getDashboard);
  const getExplorerRows = useAction(api.adminAnalytics.getExplorerRows);
  const runAdvancedQuery = useAction(api.adminAnalytics.runAdvancedQuery);
  const exportExplorerCsv = useAction(api.adminAnalytics.exportExplorerCsv);
