...
export const rateLimiter = new RateLimiter(components.rateLimiter, {
  ...
  // Interactive MCP OAuth endpoints (/mcp/authorize, /mcp/callback, /mcp/token,
  ...
  // protection lives at the Cloudflare edge instead. Client registration is separately
  // limited because each successful request creates a permanent database row.
