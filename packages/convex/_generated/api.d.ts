...
export declare const api: {
  ...
  mcp: {
    ...
    session: {
      getSession: FunctionReference<'query', 'public', { sessionId: string }, any>;
      getUserSessions: FunctionReference<'query', 'public', { userId: Id<'users'> }, any>;
    };
  };
  modelPricing: {
...
export declare const internal: {
  ...
  mcp: {
    ...
    tokens: {
      ...
      cleanupRefreshToken: FunctionReference<'mutation', 'internal', { tokenId: string }, any>;
