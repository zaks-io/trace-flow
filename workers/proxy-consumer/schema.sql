...
-- ALTER TABLE otel_traces ADD COLUMN `llm_provider` String MATERIALIZED SpanAttributes['llm.provider'];
-- ALTER TABLE otel_traces ADD COLUMN `llm_model` String MATERIALIZED SpanAttributes['llm.model'];
-- ALTER TABLE otel_traces ADD COLUMN `llm_request_id` String MATERIALIZED SpanAttributes['llm.request_id'];
...
-- ALTER TABLE otel_traces ADD INDEX idx_span_id SpanId TYPE bloom_filter(0.01) GRANULARITY 1;
