...
function getSpanAttribute(row: TraceRow, key: string): string | undefined {
  try {
...
export const allColumns: ColumnDef<TraceRow>[] = [
  {
    id: 'receivedAt',
  ...
  },
  {
    ...
    header: 'Timestamp',
    cell: ({ getValue }) => formatTimestamp(getValue<number>()),
    meta: { category: 'standard', label: 'Timestamp' },
  },
  {
    id: 'traceId',
    accessorKey: 'TraceId',
  ...
  },
  {
    ...
    meta: { category: 'standard', label: 'Span ID' },
  },
  {
    id: 'spanName',
