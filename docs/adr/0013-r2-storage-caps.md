...
- Archive Chunks contain records from one Archive Contribution and Agent Session, are capped at 1.5 MiB, and never require cross-contributor reference counting or repacking for deletion.
