...
- Show Cursor as unsupported for archive capture. Add its deterministically ordered, content-hashed
  ...
  gate.
- Add immutable contribution-and-session-scoped chunks with a 1.5 MiB packing target
  and an 8 MiB hard limit for a single element, manifests that map content chains and
