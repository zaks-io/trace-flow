...
reads shared instructions through `CLAUDE.md` importing `@AGENTS.md`.
...
| Independent PR review and main-branch drift review               | `ziw-code-review`          |
...
- Claude reads `CLAUDE.md`, which imports `@AGENTS.md`. Do not add `.claude/skills` symlinks.
...
repo differences belong in `docs/agents/workflow/config.md`, not in forked skills.
...
source and re-sync. Claude should continue to import `@AGENTS.md` through `CLAUDE.md`.
